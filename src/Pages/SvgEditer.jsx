...
function SvgEditer({svgCode,setSvgCode,textValues,setTextValues,handleAddText,makeTextBold,bold,makeTextRegular}) {
  ...
  return (
    <div className="h-[190vh] md:h-[120vh]">
      ...
      <div className="flex justify-end w-full items-center md:justify-start">
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn m-1">Text Options</label>
          <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
            <li><button onClick={handleAddText}>Add New Text Line</button></li>
          </ul>
        </div>
      </div>
